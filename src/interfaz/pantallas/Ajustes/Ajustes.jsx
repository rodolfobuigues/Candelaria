...
export function Ajustes() {
  ...
  return <section class="ajustes-pantalla">
    ...
    <section class="ajustes-seccion"><h2 class="texto-seccion">Mensajes</h2>{['confirmacion', 'pago', 'recordatorio', 'entrega'].map((id) => <button type="button" class="fila-ajuste" key={id} onClick={() => navegarA(`plantilla/${id}`)}><span>{id[0].toUpperCase() + id.slice(1)}</span><span>›</span></button>)}</section>
